...
def parse_args():
    ...
    parser.add_argument('--sn', type=str2bool, default=True, help='using spectral norm for discriminator')
    parser.add_argument('--Ra', type=str2bool, default=True, help='using Relativistic loss function')
    parser.add_argument('--gan_type', type=str, default='lsgan',
                        help='[gan / gan-gp / lsgan / wgan-gp / wgan-lp / dragan / hinge]')
    # No exist [Ra + wgan-gp, Ra + wgan-lp]
    # Ra : True, gan_type : lsgan ----------> RaLSGAN
